                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="?url=edit_user&id=<?= $User->id ?>" class="btn btn-sm btn-outline-info rounded-0">
                                <i class="fa-solid fa-edit"></i>Edit
                            </a>
                        </td>
                        <td class="text-center">
                            <a href="?url=edit_user_password&id=<?= $User->id ?>" class="btn btn-sm btn-outline-info rounded-0">
