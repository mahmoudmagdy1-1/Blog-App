                ...
                <a href="?url=show_post&id=<?= $post['id']?>">
                    <div class="card-header head_post">
                        ...
                        <?php if(isset($_SESSION['auth'])):?>
                            ...
                            <div class="float-end">
                                <a href="?url=edit_post&id=<?= $post['id'] ?>" class="btn btn-sm btn-outline-info rounded-0">
                                    <i class="fa-solid fa-edit"></i>Edit
                                </a>
                            
                                <a href="?url=delete_post&id=<?= $post['id'] ?>" class="btn btn-sm btn-outline-danger rounded-0">
